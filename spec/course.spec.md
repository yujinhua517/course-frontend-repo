...
> 課程管理系統提供完整的課程資料管理功能，包含課程的增刪改查操作。系統協助管理年度課程安排、學習類型分類、技能類別管理及課程狀態追蹤等核心業務流程。
## Feature Name : course.
## 🎯 功能概述
課程管理系統提供完整的課程管理功能，包含課程的增刪改查。系統支援多元化課程類型管理、技能分級制度、學習方式分類等業務需求，並與課程活動系統整合運作。
...
### 技術規範確認
- [ ] 檔案結構符合 Angular 18 standalone 標準
- [ ] 命名約定一致 (camelCase for frontend)
- [ ] 資料轉換規則 (snake_case ↔ camelCase)
- [ ] 錯誤處理方式 (使用 HttpErrorHandlerService)
- [ ] 響應式設計需求 (Bootstrap 5)
- [ ] 無障礙性需求 (WCAG 2.1 AA)
